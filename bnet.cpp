...
int main(int argc, char* argv[]){
    ...
    for(int ix = 0; ix < h_prior.size(); ix++) fprintf(fw,"P(h%d|Q) = %lf\n",(ix + 1), h_prior[ix]);
    fprintf(fw,"Probability that the next candy will be C, given Q: %lf\n", p_cherry); 
    fprintf(fw,"Probability that the next candy will be L, given Q: %lf\n", (1 - p_cherry)); 
